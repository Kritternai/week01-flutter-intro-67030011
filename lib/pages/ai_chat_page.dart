...
class _AiChatPageState extends State<AiChatPage> {
  ...
  final List<String> _candidateModels = ['gemini-3.5-flash'];
  ...
  Future<void> _sendMessage() async {
    ...
    setState(() {
      if (replyText != null) {
        ...
        _messages.add({
          'role': 'assistant',
          'text': 'เกิดข้อผิดพลาดในการเชื่อมต่อ AI: $lastError',
        });
      }
      _isLoading = false;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Gemini AI Chat Demo'),
        ...
        children: [
          Expanded(
            child: _messages.isEmpty
                ? const Center(
                    child: Text(
                      '👋 ยินดีต้อนรับสู่ AI Chat!\nลองพิมพ์คำถามหรือทักทายด้านล่างได้เลยครับ',
